...
SELECT FIRSTNAME FROM STUDENT WHERE FIRSTNAME LIKE '___';
3--Retrieve the first name & last name of students whose city name ends with a & contains six characters.
SELECT FIRSTNAME,LASTNAME FROM STUDENT WHERE CITY LIKE '___A';
...
SELECT FIRSTNAME FROM STUDENT WHERE WEBSITE IS NULL AND FIRSTNAME LIKE '___';
...
12--Display all the students whose name’s second character is vowe
SELECT * FROM  STUDENT WHERE FIRSTNAME LIKE '_[A,E,I,O,U]%';
13--Display the name of students having no website and name consists of minimum five character
SELECT * FROM STUDENT WHERE WEBSITE IS NULL AND FIRSTNAME LIKE '___%';
...
--------PART C-----------------------------------------
--1Display all the students whose address consist of -
--2Display all the students whose address contains single quote or double quote
--3Display all the students whose website contains @
